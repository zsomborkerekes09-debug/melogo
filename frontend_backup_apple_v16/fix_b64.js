...
const fixed_codd = `function sendChatLocation() {
...
function sendWorkerChatLocation() {
    const dest = 'Kaposvár';
    const link = \`<a href="https://www.google.com/maps/dir/?api=1&destination=${dest}" target="_blank" style="color:#2563EB; text-decoration:underline;">📍 Helyszín megnyi]0�\�O�O��ۜ�[�]H��[Y[���][[Y[��RY
	��ܚ�\�X�]\�\KZ[�]	�NY�
[�]
H[�]��[YHH[���[��ܚ�\��]Y\��Y�S�]��YJNB�X�[H[��\X�Jٝ[��[ۈ�[��]��][ۗ

Wʗ���J�ٝ[��[ۈ�[��ܚ�\��]��][ۗ

Wʗ����J��Wʗ��ʗK���^Y���JN��˝ܚ]Q�[T�[��	�[�^�[	�[	�]�	�N�ۜ��K���	�ۙI�N