...
function documentSnapshotFromJSON(t, e, n) {
    if (common.__PRIVATE_validateJSON(e, DocumentSnapshot._jsonSchema)) {
        ...
        // Parse the bundle data.
                const r = common.__PRIVATE_newSerializer(t._databaseId), s = common.__PRIVATE_createBundleReaderSync(e.bundle, r), a = s.ju(), o = new common.__PRIVATE_BundleLoader(s.getMetadata(), r);
...
exports.CACHE_SIZE_UNLIMITED = common.on;
