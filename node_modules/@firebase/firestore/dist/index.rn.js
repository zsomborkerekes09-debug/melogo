...
import { _ as s, F as a, a as o, b as i, c, O as h, D as d, d as p, Q as _, e as f, f as m, C as g, g as I, h as S, i as T, j as P, k as b, l as E, m as C, n as v, o as R, p as V, q, r as O, s as M, B, t as N, R as L, u as $, v as W, A as k, w as J, x as G, y as j, z as U, E as H, G as Y, H as K, I as Z, J as tt, K as et, L as nt, M as rt, N as st, P as at, S as ot, T as it, U as ut, V as ct, W as lt, X as ht, Y as dt, Z as pt, $ as _t, a0 as ft, a1 as mt, a2 as yt, a3 as gt, a4 as wt, a5 as It, a6 as At, a7 as St, a8 as Tt, a9 as Pt, aa as bt, ab as Et, ac as Ct, ad as vt, ae as Rt, af as Ft, ag as Dt, ah as Vt, ai as Qt, aj as xt, ak as qt, al as Ot, am as Mt, an as Bt, ao as Nt, ap as Lt, aq as $t, ar as Wt, as as kt, at as Jt } from "./common-768c0351.rn.js";

export { A as AbstractUserDataWriter, w as Bytes, aX as CACHE_SIZE_UNLIMITED, aI as CollectionReference, D as DocumentReference, a4 as FieldPath, aK as FieldValue, F as Firestore, l as FirestoreError, aV as GeoPoint, aF as LoadBundleTask, Q as Query, aW as Timestamp, aT as VectorValue, X as _AutoId, b3 as _ByteString, aZ as _DatabaseId, u as _DocumentKey, b5 as _EmptyAppCheckTokenProvider, b4 as _EmptyAuthCredentialsProvider, b2 as _FieldPath, y as _cast, b1 as _debugAssert, a$ as _internalAggregationQueryToProtoRunAggregationQueryRequest, a_ as _internalQueryToProtoQueryTarget, aY as _isBase64Available, ak as _logWarn, b0 as _validateIsNotUsedTogether, aL as arrayRemove, aM as arrayUnion, av as clearIndexedDbPersistence, aG as collection, aH as collectionGroup, aw as connectFirestoreEmulator, aN as deleteField, ax as disableNetwork, ad as doc, au as documentId, ay as enableIndexedDbPersistence, az as enableMultiTabIndexedDbPersistence, aA as enableNetwork, z as ensureFirestoreConfigured, aB as getFirestore, aO as increment, aC as initializeFirestore, ai as loadBundle, aS as maximum, aR as minimum, aj as namedQuery, x as queryEqual, aJ as refEqual, aP as serverTimestamp, aU as setLogLevel, aD as terminate, aQ as vector, aE as waitForPendingWrites } from "./common-768c0351.rn.js";
 ...
 */ function __PRIVATE_validateHasExplicitOrderByForLimitToLast(t) {
    if ("L" /* LimitType.Last */ === t.limitType && 0 === t.explicitOrderBy.length) throw new E(C.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
function query(t, e, ...n) {
    ...
    e instanceof AppliableConstraint && r.push(e), r = r.concat(n), function __PRIVATE_validateQueryConstraintArray(t) {
        ...
        if (e > 1 || e > 0 && n > 0) throw new E(C.INVALID_ARGUMENT, "InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.");
    }
    /**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ class QueryFieldFilterConstraint extends QueryConstraint {
    ...
    _parse(t) {
        const e = m(t.firestore), n = function __PRIVATE_newQueryFilter(t, e, n, r, s, a, o) {
            let i;
            if (s.isKeyField()) {
                if ("array-contains" /* Operator.ARRAY_CONTAINS */ === a || "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ === a) throw new E(C.INVALID_ARGUMENT, `Invalid Query. You can't perform '${a}' queries on documentId().`);
 ...
 */ class QueryOrderByConstraint extends QueryConstraint {
    ...
    _apply(t) {
        const e = function __PRIVATE_newQueryOrderBy(t, e, n) {
            if (null !== t.startAt) throw new E(C.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new E(C.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            const r = new V(e, n);
            return r;
        }
        /**
 ...
 */ class QueryEndAtConstraint extends QueryConstraint {
    ...
    _apply(t) {
        const e = __PRIVATE_newQueryBoundFromDocOrFields(t, this.type, this._docOrFields, this._inclusive);
        return new _(t.firestore, t.converter, b(t._query, e));
    }
}
...
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(t, e, n, r) {
    if (n[0] = Gt(n[0]), n[0] instanceof DocumentSnapshot$1) return function __PRIVATE_newQueryBoundFromDocument(t, e, n, r, s) {
        if (!r) throw new E(C.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${n}().`);
        const a = [];
        ...
        // results.
            ...
            if (M(t)) throw new E(C.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
                const t = n.field.canonicalString();
                throw new E(C.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${t}' (used as the orderBy) does not exist.`);
            }
            a.push(t);
        }
        return new B(a, s);
 ...
 */ (t._query, t.firestore._databaseId, e, n[0]._document, r);
    {
        ...
        return function __PRIVATE_newQueryBoundFromFields(t, e, n, r, s, a) {
            ...
            if (s.length > o.length) throw new E(C.INVALID_ARGUMENT, `Too many arguments provided to ${r}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
            const i = [];
            for (let a = 0; a < s.length; a++) {
                const c = s[a];
                if (o[a].field.isKeyField()) {
                    if ("string" != typeof c) throw new E(C.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${r}(), but got a ${typeof c}`);
                    if (!N(t) && -1 !== c.indexOf("/")) throw new E(C.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${r}() must be a plain document ID, but '${c}' contains a slash.`);
                    const n = t.path.child(L.fromString(c));
                    if (!$.isDocumentKey(n)) throw new E(C.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${r}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const s = new $(n);
                    i.push(O(e, s));
                } else {
                    const t = v(n, r, c);
...
function __PRIVATE_parseDocumentIdValue(t, e, n) {
    if ("string" == typeof (n = Gt(n))) {
        if ("" === n) throw new E(C.INVALID_ARGUMENT, "Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!N(e) && -1 !== n.indexOf("/")) throw new E(C.INVALID_ARGUMENT, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const r = e.path.child(L.fromString(n));
        if (!$.isDocumentKey(r)) throw new E(C.INVALID_ARGUMENT, `Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);
        return O(t, new $(r));
    }
    if (n instanceof d) return O(t, n._key);
    throw new E(C.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${W(n)}.`);
}
 ...
 */ function __PRIVATE_validateDisjunctiveFilterElements(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new E(C.INVALID_ARGUMENT, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
}
 ...
 */ function __PRIVATE_validateNewFieldFilter(t, e) {
    ...
    throw n === e.op ? new E(C.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new E(C.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
}

function __PRIVATE_validateQueryFilterConstraint(t, e) {
    if (!(e instanceof QueryFieldFilterConstraint || e instanceof QueryCompositeFilterConstraint)) throw new E(C.INVALID_ARGUMENT, `Function ${t}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
}
 ...
 */ class DocumentSnapshot extends DocumentSnapshot$1 {
     ...
     */    toJSON() {
        if (this.metadata.hasPendingWrites) throw new E(C.FAILED_PRECONDITION, "DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");
...
function documentSnapshotFromJSON(t, e, n) {
    if (ot(e, DocumentSnapshot._jsonSchema)) {
        if (e.bundle === zt) throw new E(C.INVALID_ARGUMENT, "The provided JSON object was created in a client environment, which is not supported.");
        // Parse the bundle data.
                const r = it(t._databaseId), s = ut(e.bundle, r), a = s.ju(), o = new ct(s.getMetadata(), r);
        for (const t of a) o.Ja(t);
        // Ensure that we have the correct number of documents in the bundle.
                const i = o.documents;
        if (1 !== i.length) throw new E(C.INVALID_ARGUMENT, `Expected bundle data to contain 1 document, but it contains ${i.length} documents.`);
 ...
 */ class QuerySnapshot {
     ...
     */    docChanges(t = {}) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new E(C.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
     ...
     */    toJSON() {
        if (this.metadata.hasPendingWrites) throw new E(C.FAILED_PRECONDITION, "QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                const t = {};
...
function querySnapshotFromJSON(t, e, n) {
    if (ot(e, QuerySnapshot._jsonSchema)) {
        ...
        // Parse the bundle data.
                const r = it(t._databaseId), s = ut(e.bundle, r), a = s.ju(), o = new ct(s.getMetadata(), r);
        for (const t of a) o.Ja(t);
        if (1 !== o.queries.length) throw new E(C.INVALID_ARGUMENT, `Snapshot data expected 1 query but found ${o.queries.length} queries.`);
...
class WriteBatch {
    ...
    _verifyNotCommitted() {
        if (this._committed) throw new E(C.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}

function __PRIVATE_validateReference(t, e) {
    if ((t = Gt(t)).firestore !== e) throw new E(C.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function runTransaction(t, e, n) {
    ...
    !function __PRIVATE_validateTransactionOptions(t) {
        if (t.maxAttempts < 1) throw new E(C.INVALID_ARGUMENT, "Max attempts must be at least 1");
    }(r);
    const s = U(t);
 ...
 */ function getDocFromCache(t) {
    ...
    return bt(n, t._key).then((n => new DocumentSnapshot(e, r, t._key, n, new SnapshotMetadata(null !== n && n.hasLocalMutations, 
 ...
 */ function getDocs(t) {
    t = j(t, _);
    const e = j(t.firestore, a), n = U(e), r = new K(e);
    return __PRIVATE_validateHasExplicitOrderByForLimitToLast(t._query), Et(n, t._query).then((n => new QuerySnapshot(e, r, t, n)));
}
 ...
 * @internal
 */ (e);
    if (s.error) throw new E(C.INVALID_ARGUMENT, s.error);
    let a, o = 0;
 ...
 */ (r, s, a, t, n[o]);
    ...
    throw new E(C.INVALID_ARGUMENT, `unsupported bundle source: ${s.bundleSource}`);
}
    ...
    const r = function __PRIVATE_parseIndexes(t) {
        const e = "string" == typeof t ? function __PRIVATE_tryParseJson(t) {
            try {
                ...
                throw new E(C.INVALID_ARGUMENT, "Failed to parse JSON: " + t?.message);
            }
        }(t) : t, n = [];
...
function __PRIVATE_tryGetString(t, e) {
    if ("string" != typeof t[e]) throw new E(C.INVALID_ARGUMENT, "Missing string value for: " + e);
    return t[e];
}
