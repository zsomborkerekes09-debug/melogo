 ...
 * limitations under the License.
 */
const m = new a("@firebase/firestore");
...
/** AppCheck token provider for the Lite SDK. */ class __PRIVATE_LiteAppCheckTokenProvider {
    constructor(e, t) {
        this.m = t, this.appCheck = null, this.T = null, c(e) && e.settings.appCheckToken && (this.T = e.settings.appCheckToken), 
        t.onInit((e => {
            this.appCheck = e;
        }));
    }
 ...
 */ function connectFirestoreEmulator(e, r, o, a = {}) {
    ...
    u && n(`https://${l}`), _.host !== M && _.host !== l && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");
    const h = {
        ..._,
        host: l,
        ssl: u,
