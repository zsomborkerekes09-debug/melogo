import { O as _, ax as n, ay as s, az as k, g, s as C, aA as E, af as T, j as w, aB as A, aC as V, aD as I, as as R, ao as $, aE as F, aF as U, aG as M, aH as N, M as L, aI as q, aJ as B, w as rt, aK as H, aL as W, aM as G, aN as K, aO as J, I as Q, C as j, J as X, f as d, e as f, k as P, i as p, aP as Y, F as h } from "./common.browser.js";
 ...
 */ class OptionsUtil {
    ...
    getOptionsProto(e, t, n) {
        ...
        // APPLY OPTIONS OVERRIDES
                if (n) {
            const t = new Map(g(n, ((t, n) => [ k.fromServerFormat(n), void 0 !== t ? s(t, e) : null ])));
            r.setAll(t);
        }
...
function _field(e, t) {
    return new Field("string" == typeof e ? E === e ? T()._internalPath : w("field", e) : e._internalPath, t);
}
...
function timestampTruncate(e, t, n) {
    const r = V(t) ? __PRIVATE_valueToDefaultExpr$1(t) : t;
...
class __PRIVATE_PipelineValueExpression extends Expression {
     ...
     * @internal
     */    _toProto(e) {
        return U(this.pipeline._toProto(e));
    }
    /**
     * @internal
     */    _readUserData(e) {
...
function __PRIVATE_isSelectable(e) {
    const t = e;
    return t.selectable && V(t.alias) && __PRIVATE_isExpr(t.expr);
}
...
function __PRIVATE_isAliasedAggregate(e) {
    const t = e;
    return V(t.alias) && t.aggregate instanceof AggregateFunction;
}
...
function __PRIVATE_toPipeline(e, t) {
    let n;
    n = M(e) ? t.pipeline().collectionGroup(e.collectionGroup) : N(e) ? t.pipeline().documents([ L(t, e.path.canonicalString()) ]) : t.pipeline().collection(e.path.canonicalString());
    // filters
 ...
 */
    return function __PRIVATE_valueToDefaultExpr(e) {
        ...
        if (e instanceof Expression) return e;
        t = n(e) ? map(e) : e instanceof Array ? array(e) : 
        /**
...
class __PRIVATE_FindNearest extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.field._toProto(e), this.vectorValue._toProto(e), I(this.distanceMeasure) ]
        };
    }
    _readUserData(e) {
...
class __PRIVATE_Limit extends Stage {
    ...
    constructor(e, t) {
        A(!isNaN(e) && e !== 1 / 0 && e !== -1 / 0, 34860), super(t), this.limit = e;
    }
    /**
     * @internal
     * @private
...
class __PRIVATE_Sample extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ W(e, this.rate), I(this.mode) ]
        };
    }
    _readUserData(e) {
        super._readUserData(e);
...
class __PRIVATE_Replace extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.map._toProto(e), I(__PRIVATE_Replace.ue) ]
        };
    }
    _readUserData(e) {
 ...
 */ function __PRIVATE_readUserDataHelper(e, t) {
    return G(e) ? e._readUserData(t) : Array.isArray(e) ? e.forEach((e => e._readUserData(t))) : e instanceof Map ? e.forEach((e => e._readUserData(t))) : Object.values(e).forEach((e => e._readUserData(t))), 
    e;
}
 ...
 */ class Pipeline {
    ...
    removeFields(e, ...t) {
        // Process argument union(s) from method overloads
        const n = __PRIVATE_isField(e) || V(e) ? {} : e, r = (__PRIVATE_isField(e) || V(e) ? [ e, ...t ] : e.fields).map((e => V(e) ? field(e) : e)), s = new __PRIVATE_RemoveFields(r, n);
        // Add stage to the pipeline
    ...
    select(e, ...t) {
        // Process argument union(s) from method overloads
        const n = __PRIVATE_isSelectable(e) || V(e) ? {} : e, r = __PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || V(e) ? [ e, ...t ] : e.selections), s = new __PRIVATE_Select(r, n);
        // Add stage to the pipeline
        return this._addStage(s);
    }
    where(e) {
    ...
    limit(e) {
        // Process argument union(s) from method overloads
        const t = K(e) ? {} : e, n = K(e) ? e : e.limit, r = new __PRIVATE_Limit(n, t);
        // Add stage to the pipeline
        return this._addStage(r);
    }
    distinct(e, ...t) {
        // Process argument union(s) from method overloads
        const n = V(e) || __PRIVATE_isSelectable(e) ? {} : e, r = __PRIVATE_selectablesToMap(V(e) || __PRIVATE_isSelectable(e) ? [ e, ...t ] : e.groups), s = new __PRIVATE_Distinct(r, n);
        // Add stage to the pipeline
        return this._addStage(s);
    }
    aggregate(e, ...t) {
 ...
 */ (r), o = __PRIVATE_selectablesToMap(s), a = new __PRIVATE_Aggregate(o, i, n);
    ...
    replaceWith(e) {
        // Process argument union(s) from method overloads
        const t = V(e) || __PRIVATE_isExpr(e) ? {} : e, n = __PRIVATE_fieldOrExpression(V(e) || __PRIVATE_isExpr(e) ? e : e.map), r = new __PRIVATE_Replace(n, t);
        // Add stage to the pipeline
        return this._addStage(r);
    }
    sample(e) {
        ...
        const t = K(e) ? {} : e;
        let n, r;
        K(e) ? (n = e, r = "documents") : K(e.documents) ? (n = e.documents, r = "documents") : (n = e.percentage, 
        r = "percent");
        // Create stage object
 ...
 */ (e) ? ({other: n, ...t} = e) : (t = {}, n = e);
    ...
    unnest(e, t) {
        ...
        V(s) && (n.indexField = _field(s, "unnest"));
        // Create stage object
     ...
     */    rawStage(e, t, r) {
        // Convert user land convenience types to internal types
        const s = t.map((e => e instanceof Expression || e instanceof AggregateFunction ? e : n(e) ? function __PRIVATE__mapValue(e) {
            const t = new Map;
...
class PipelineSource {
    ...
    collection(e) {
        // Process argument union(s) from method overloads
        const t = V(e) || J(e) ? {} : e, n = V(e) || J(e) ? e : e.collection;
        // Validate that a user provided reference is for the same Firestore DB
        J(n) && this._validateReference(n);
        // Convert user land convenience types to internal types
                const r = V(n) ? n : n.path, s = new __PRIVATE_CollectionSource(r, t);
        // Create stage object
                // Add stage to the pipeline
    ...
    documents(e) {
        ...
        n.filter((e => e instanceof Q)).forEach((e => this._validateReference(e)));
        // Convert user land convenience types to internal types
        const r = n.map((e => V(e) ? e : e.path)), s = new __PRIVATE_DocumentsSource(r, t);
        // Create stage object
                // Add stage to the pipeline
        return this._createPipeline([ s ]);
    }
 ...
 */ function execute(e) {
    ...
    const t = d(e._db), n = f(e._db, h), r = P(n).ce(3 /* UserDataSource.Argument */ , "execute");
    e._readUserData(r);
    const s = new p(n), i = new __PRIVATE_StructuredPipelineOptions({}, {});
    i._readUserData(r);
    ...
    return Y(t, o).then((t => {
        ...
        const r = t.length > 0 ? t[0].executionTime?.toTimestamp() : void 0, i = t.filter((e => !!e.fields)).map((e => new PipelineResult(s, e.fields, e.key?.path ? new Q(n, null, e.key) : void 0, e.createTime?.toTimestamp(), e.updateTime?.toTimestamp())));
