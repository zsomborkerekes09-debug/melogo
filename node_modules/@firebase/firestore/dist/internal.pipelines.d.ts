...
declare class Pipeline_2 implements ProtoSerializable<Pipeline_3>, UserData {
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    define(aliasedExpression: AliasedExpression, ...additionalExpressions: AliasedExpression[]): Pipeline_2;
    /**
     * @public
     * Defines one or more variables in the pipeline's scope. `define` is used to bind a value to a
     * variable for internal reuse within the pipeline body (accessed via the `variable()` function).
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    define(options: DefineStageOptions): Pipeline_2;
    /**
     * @public
     ...
     */
    search(options: SearchStageOptions): Pipeline_2;
    /**
     ...
     * @protected
     */
    protected newPipeline(db: Firestore_2 | undefined, stages: Stage[]): Pipeline_2;
}
 ...
 * Watch service.
 */
declare type RemoteTargetId = number & {
 ...
 */
export declare function subcollection(path: string): Pipeline_2;
 ...
 */
export declare function subcollection(options: SubcollectionStageOptions): Pipeline_2;
