...
import { _isFirebaseServerApp as h, _getProvider, getApp as f, _removeServiceInstance as m } from "@firebase/app";
...
/** AppCheck token provider for the Lite SDK. */ class __PRIVATE_LiteAppCheckTokenProvider {
    constructor(e, t) {
        this.m = t, this.appCheck = null, this.T = null, h(e) && e.settings.appCheckToken && (this.T = e.settings.appCheckToken), 
        t.onInit((e => {
            this.appCheck = e;
        }));
    }
...
class __PRIVATE_RestConnection {
    ...
    constructor(e) {
        ...
        this.V = t + "://" + e.host, this.R = `projects/${r}/databases/${n}`, this.A = this.databaseId.database === P ? `project_id=${r}` : `project_id=${r}&database_id=${n}`;
    }
    I(e, r, n, i, s) {
...
class Timestamp {
     ...
     */    static fromMillis(e) {
        const t = Math.floor(e / 1e3), r = Math.floor((e - 1e3 * t) * N);
    ...
    t) {
        ...
        if (e < D) throw new FirestoreError(T.INVALID_ARGUMENT, "Timestamp seconds out of range: " + e);
...
function __PRIVATE_typeOrder(e) {
    ...
    function __PRIVATE_isMaxValue(e) {
        return (((e.mapValue || {}).fields || {}).__type__ || {}).stringValue === C;
    }
    /**
 * @license
 ...
 */ (e) ? 9007199254740991 /* TypeOrder.MaxValue */ : 
    ...
    function __PRIVATE_isVectorValue(e) {
        const t = (e?.mapValue?.fields || {})[S]?.stringValue;
        return t === q;
    }
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const M = "ComponentProvider", Q = new Map;
 ...
 */ const U = 1048576, k = "firestore.googleapis.com", j = !0;
...
class FirestoreSettingsImpl {
    constructor(e) {
        ...
        void 0 === e.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== e.cacheSizeBytes && e.cacheSizeBytes < U) throw new FirestoreError(T.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
...
class Firestore {
     ...
     */    _terminate() {
        return function __PRIVATE_removeComponents(e) {
            const t = Q.get(e);
            t && (__PRIVATE_logDebug(M, "Removing Datastore"), Q.delete(e), t.terminate());
 ...
 */ function connectFirestoreEmulator(e, r, n, i = {}) {
    ...
    u && s(`https://${l}`), _.host !== k && _.host !== l && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");
    const h = {
        ..._,
        host: l,
        ssl: u,
...
/** Parse update data from a list of field/value arguments. */ function __PRIVATE_parseUpdateVarargs(e, t, r, n, i, s) {
    const o = e.ce(1 /* UserDataSource.Update */ , t, r), a = [ __PRIVATE_fieldPathFromArgument(t, n, r) ], _ = [ i ];
