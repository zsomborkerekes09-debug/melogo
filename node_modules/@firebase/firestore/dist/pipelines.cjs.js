...
var common = require('./common-8c2c4a59.cjs.js');
...
function timestampTruncate(e, n, t) {
    const r = common.__PRIVATE_isString(n) ? __PRIVATE_valueToDefaultExpr$1(n) : n;
...
class __PRIVATE_PipelineValueExpression extends Expression {
     ...
     * @internal
     */    _toProto(e) {
        return common.__PRIVATE_toPipelineValue(this.pipeline._toProto(e));
    }
    /**
     * @internal
     */    _readUserData(e) {
...
function __PRIVATE_toPipeline(e, n) {
    ...
    // orders
        const r = common.__PRIVATE_queryNormalizedOrderBy(e), s = e.explicitOrderBy.map((e => field(e.field.canonicalString()).exists()));
    if (s.length > 0) {
...
function __PRIVATE_selectablesToObject(e) {
    ...
    for (const t of e) {
        ...
        r = t.expr) : common.fail(21273, {
            selectable: t
        }), void 0 !== n[e]) throw new common.FirestoreError("invalid-argument", `Duplicate alias or field '${e}'`);
        n[e] = r;
    }
    return n;
}
 ...
 */
    return function __PRIVATE_valueToDefaultExpr(e) {
        ...
        if (e instanceof Expression) return e;
        n = common.__PRIVATE_isPlainObject(e) ? map(e) : e instanceof Array ? array(e) : 
        /**
 ...
 */ class __PRIVATE_Define extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common.__PRIVATE_toMapValue(e, this.l) ]
        };
    }
    _readUserData(e) {
...
class __PRIVATE_Replace extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.map._toProto(e), common.__PRIVATE_toStringValue(__PRIVATE_Replace.A) ]
        };
    }
    _readUserData(e) {
 ...
 */ function __PRIVATE_readUserDataHelper(e, n) {
    return common.__PRIVATE_isUserData(e) ? e._readUserData(n) : Array.isArray(e) ? e.forEach((e => e._readUserData(n))) : e instanceof Map ? e.forEach((e => e._readUserData(n))) : Object.values(e).forEach((e => e._readUserData(n))), 
    e;
}
 ...
 */ class Pipeline$1 {
    ...
    removeFields(e, ...n) {
        // Process argument union(s) from method overloads
        const t = __PRIVATE_isField(e) || common.__PRIVATE_isString(e) ? {} : e, r = (__PRIVATE_isField(e) || common.__PRIVATE_isString(e) ? [ e, ...n ] : e.fields).map((e => common.__PRIVATE_isString(e) ? field(e) : e)), s = new __PRIVATE_RemoveFields(r, t);
        // Add stage to the pipeline
    ...
    select(e, ...n) {
        // Process argument union(s) from method overloads
        const t = __PRIVATE_isSelectable(e) || common.__PRIVATE_isString(e) ? {} : e, r = __PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || common.__PRIVATE_isString(e) ? [ e, ...n ] : e.selections), s = new __PRIVATE_Select(r, t);
        // Add stage to the pipeline
        return this._addStage(s);
    }
    where(e) {
    ...
    distinct(e, ...n) {
        // Process argument union(s) from method overloads
        const t = common.__PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? {} : e, r = __PRIVATE_selectablesToMap(common.__PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? [ e, ...n ] : e.groups), s = new __PRIVATE_Distinct(r, t);
        // Add stage to the pipeline
        return this._addStage(s);
    }
    aggregate(e, ...n) {
 ...
 */ (e) ? ({other: t, ...n} = e) : (n = {}, t = e);
    ...
    unnest(e, n) {
        ...
        common.__PRIVATE_isString(s) && (t.indexField = _field(s, "unnest"));
        // Create stage object
...
class PipelineSource {
    ...
    collection(e) {
        ...
        // Convert user land convenience types to internal types
                const r = common.__PRIVATE_isString(t) ? t : t.path, s = new __PRIVATE_CollectionSource(r, n);
        // Create stage object
                // Add stage to the pipeline
    ...
    documents(e) {
        ...
        // Convert user land convenience types to internal types
        const r = t.map((e => common.__PRIVATE_isString(e) ? e : e.path)), s = new __PRIVATE_DocumentsSource(r, n);
        // Create stage object
                // Add stage to the pipeline
        return this._createPipeline([ s ]);
    }
...
function subcollection(e) {
    // Process argument union(s) from method overloads
    let n, t;
    common.__PRIVATE_isString(e) ? (n = e, t = {}) : ({path: n, ...t} = e);
    // Create stage object
 ...
 */ function execute(e) {
    ...
    const i = common.__PRIVATE_cast(t._db, common.Firestore), o = common.ensureFirestoreConfigured(i), u = common.__PRIVATE_newUserDataReader(i).V(3 /* UserDataSource.Argument */ , "execute");
    t._readUserData(u);
    const _ = new common.__PRIVATE_ExpUserDataWriter(i), l = new common.__PRIVATE_StructuredPipelineOptions(s, r);
    l._readUserData(u);
    ...
    return common.__PRIVATE_firestoreClientExecutePipeline(o, c).then((e => {
        ...
        const n = e.length > 0 ? e[0].executionTime?.toTimestamp() : void 0, r = e.filter((e => !!e.fields)).map((e => new PipelineResult(_, e.fields, e.key?.path ? new common.DocumentReference(i, null, e.key) : void 0, e.createTime?.toTimestamp(), e.updateTime?.toTimestamp())));
