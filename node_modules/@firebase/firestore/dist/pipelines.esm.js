import { F as Firestore, d as FirestoreError, b6 as F, aT as documentId$1, j as __PRIVATE_fieldPathFromArgument, b7 as __PRIVATE_hardAssert, b8 as __PRIVATE_parseData, b9 as OptionsUtil, ba as __PRIVATE_isString, bb as __PRIVATE_toStringValue, bc as __PRIVATE_isCollectionReference, D as DocumentReference, e as D, av as CollectionReference, bd as __PRIVATE_isOptionalEqual, y as __PRIVATE_cast, z as ensureFirestoreConfigured, g as __PRIVATE_newUserDataReader, H as __PRIVATE_ExpUserDataWriter, be as __PRIVATE_firestoreClientExecutePipeline, bf as __PRIVATE_isPlainObject, aA as VectorValue, b4 as vector, u as __PRIVATE_isCollectionGroupQuery, bg as __PRIVATE_isDocumentQuery$1, a6 as doc, q as __PRIVATE_queryNormalizedOrderBy, bh as __PRIVATE_isNumber$1, b0 as refEqual, bi as __PRIVATE_StructuredPipelineOptions, bj as __PRIVATE_toMapValue, i as FieldFilter, U as fail, C as CompositeFilter, bk as toNumber, bl as __PRIVATE_toPipelineValue, bm as __PRIVATE_isUserData, bn as StructuredPipeline } from './common-b3e8012f.esm.js';
export { bo as _internalPipelineToExecutePipelineRequestProto } from './common-b3e8012f.esm.js';
import '@firebase/app';
 ...
 */ function execute(e) {
    ...
    const i = __PRIVATE_cast(t._db, Firestore), o = ensureFirestoreConfigured(i), u = __PRIVATE_newUserDataReader(i).V(3 /* UserDataSource.Argument */ , "execute");
    t._readUserData(u);
