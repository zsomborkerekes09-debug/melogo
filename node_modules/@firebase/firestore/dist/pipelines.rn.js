import { b6 as u, l as E, b7 as l, au as x, d as p, b8 as A, b9 as w, ba as D, bb as y, bc as F, aT as z, aQ as Q, bd as X, be as ee, t as N, bf as ne, ad as vt, q, o as R, a1 as mt, C as g, bg as te, bh as re, bi as se, bj as ie, D as d, m as C, aI as oe, bk as ae, aJ as ue, y as j, F as a, z as U, f as m, H as K, bl as _e, bm as le, bn as ce } from "./common-768c0351.rn.js";

export { bo as _internalPipelineToExecutePipelineRequestProto } from "./common-768c0351.rn.js";
 ...
 */ class Expression {
     ...
     */    asBoolean() {
        ...
        throw new E("invalid-argument", `Conversion of type ${typeof this} to BooleanExpression not supported.`);
    }
    subtract(e) {
...
function __PRIVATE_selectablesToObject(e) {
    ...
    for (const t of e) {
        ...
        r = t.expr) : mt(21273, {
            selectable: t
        }), void 0 !== n[e]) throw new E("invalid-argument", `Duplicate alias or field '${e}'`);
        n[e] = r;
    }
    return n;
}
 ...
 */ class Pipeline$1 {
    ...
    aggregate(e, ...n) {
        ...
        const t = __PRIVATE_isAliasedAggregate(e) ? {} : e, r = __PRIVATE_isAliasedAggregate(e) ? [ e, ...n ] : e.accumulators, s = __PRIVATE_isAliasedAggregate(e) ? [] : e.groups ?? [], i = function __PRIVATE_aliasedAggregateToMap(e) {
            return e.reduce(((e, n) => {
                if (void 0 !== e.get(n.alias)) throw new E("invalid-argument", `Duplicate alias or field '${n.alias}'`);
...
class PipelineSource {
    ...
    _validateReference(e) {
        ...
        if (!n.isEqual(this.databaseId)) throw new E(C.INVALID_ARGUMENT, `Invalid ${e instanceof oe ? "CollectionReference" : "DocumentReference"}. The project ID ("${n.projectId}") or the database ("${n.database}") does not match the project ID ("${this.databaseId.projectId}") and database ("${this.databaseId.database}") of the target database of this Pipeline.`);
    }
}
